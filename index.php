...
<html>
	<head>
		...
		<style type="text/css">
			...
			html { background: #000 url('images/bg.jpg'); background-size:cover; background-attachment:fixed; color: #FFF;font-family: sans-serif; font-size: 1.8em;padding: 1em 2em; }
	...
	<body>
		...
		local time<span><?=date("Y-F-j H:i:s", time());?></span> <!-- Server time is acutally PHP time since PHP wants to bitch -->
